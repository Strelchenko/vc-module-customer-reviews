...
angular.module(moduleTemplateName, [])
    ...
    .run([
        '$rootScope', 'platformWebApp.mainMenuService', 'platformWebApp.widgetService', '$state',
        function($rootScope, mainMenuService, widgetService, $state) {
            ...
            //Register reviews widget inside product blade
            var itemProductRateWidget = {
                controller: 'CustomerReviews.Web.averageProductRateWidgetController',
                template: 'Modules/$(CustomerReviews.Web)/Scripts/widgets/averageProductRateWidget.tpl.html'
            };
            widgetService.registerWidget(itemProductRateWidget, 'itemDetail');
        }
    ]);