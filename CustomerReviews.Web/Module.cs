...
namespace CustomerReviews.Web
{
    public class Module : ModuleBase
    {
        ...
        public override void SetupDatabase()
        {
            ...
            {
                var initializer = new SetupDatabaseInitializer<CustomerReviewRepository, Configuration>();
        ...
        public override void Initialize()
        {
            ...
            _container.RegisterType<ICustomerReviewRepository>(new InjectionFactory(c =>
                new CustomerReviewRepository(_connectionString, new EntityPrimaryKeyGeneratorInterceptor(),
            ...
            _container.RegisterType<IAverageProductRateSearchService, AverageProductRateSearchService>();
            _container.RegisterType<IAverageProductRateService, AverageProductRateService>();
